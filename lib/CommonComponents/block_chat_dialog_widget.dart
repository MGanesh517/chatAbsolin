...
class BlockChatDialog extends StatelessWidget {
  final UserDetails? otherUser;
  final String? chatId;
  BlockChatDialog({Key? key, required this.otherUser, this.chatId}) : super(key: key);
      ...
      child: StatefulBuilder(builder: (BuildContext context, StateSetter setState) {
        return AlertDialog(
            ...
            content: Wrap(
              children: [
                Center(
                  child: Text("Are You Sure you want to block ${otherUser!.name}?",
                      textAlign: TextAlign.center,
              ...
              Row(
                ...
                children: [
                  MaterialButton(
                    ...
                    onPressed: () {
                      Get.back();
                      controller.blockUnBlockChat(controller.chatDetails.data!.chat!.id, true);
                    },
                    child: Text(
                      "Block",
                      style: TextStyle(
