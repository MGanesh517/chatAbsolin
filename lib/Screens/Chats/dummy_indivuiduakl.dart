...
//         //                                             if (controller.messagesList[index].type == 'info')
//         //                                               Container(
//         //                                                 constraints: BoxConstraints(
//         //                                                   maxWidth: MediaQuery.of(context).size.width * 0.7,
//         //                                                 ),
...
//         //                                                       maxWidth: MediaQuery.of(context).size.width * 0.7,
//         //                                                     ),
//         //                                                     child: controller.messagesList[index].user!.dUserId == CommonService.instance.userId
//         //                                                         ? getSenderView(
//         //                                                             controller.messagesList[index].type == 'image',
//         //                                                             controller.messagesList[index].type == 'image'
//         //                                                                 ? "http://hpsconnect_io.dev.absol.in/${controller.messagesList[index].file}"
...
//         //                                             // Spacing after messages
//         //                                             SizedBox(
//         //                                               height: CommonService.instance.userId != controller.chatDetails.data!.chat!.createdBy!.dUserId && 
//         //                                                     controller.messagesList.length == 1 ? 100 : 20,
//         //                                             ),
//         //                                           ],
//         //                                         );
//         //                                       },
...
//         //                             onPressed: () {
//         //                               if (controller.messageTextController.text.trim().isNotEmpty) {
//         //                                   print('onfield submit msg send ::: ${controller.sendMessage(controller.chatDetails.data!.chat!.id)}');
//         //                                 controller.sendMessage(controller.chatDetails.data!.chat!.id);
//         //                                 controller.scrollToBottom();
//         //                               }
//         //                             },
