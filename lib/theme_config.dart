...
class MyTheme with ChangeNotifier {
  bool _isDark = Hive.box('settings').get('darkMode', defaultValue: false) as bool;

  bool _useSystemTheme = Hive.box('settings').get('useSystemTheme', defaultValue: false) as bool;

  String accentColor = Hive.box('settings').get('themeColor', defaultValue: 'App Primary') as String;
  String canvasColor = Hive.box('settings').get('canvasColor', defaultValue: 'Grey') as String;
  String cardColor = Hive.box('settings').get('cardColor', defaultValue: 'Grey900') as String;
  ...
  int bottomGrad = Hive.box('settings').get('bottomGrad', defaultValue: 3) as int;
  ...
  Color getColor(String color, int hue) {
    switch (color) {
      case 'AppColor':
        return const Color.fromRGBO(19, 51, 99, 1).withOpacity(hue / 100);
      case 'Red':
  ...
  Color currentColor() {
    switch (accentColor) {
      case 'App Primary':
        return const Color.fromRGBO(19, 51, 99, 1);
      case 'Red':
